...
''''FOR RASUK''''
Public Function DrawSection(ByVal locx As Double, ByVal _
...
''''section dim.
cVrTemp = 25
If cVr < 25 Or cVr > 30 Then
cVrTemp = 25
End If


corner1(0) = pt(0) - 6.5 * cVrTemp
...
text = Str(h)
  ...
  acadObj.Update
Call ArrowVertical(pt(0) - 5 * cVrTemp, pt(5), -h, -30, -15, "BeamDimension")
Call ArrowHorizontal(pt(0) - 6 * cVrTemp, pt(5), 2 * cVrTemp, 0, 0, "BeamDimension")
Call ArrowHorizontal(pt(0) - 6 * cVrTemp, pt(5) - h, 2 * cVrTemp, 0, 0, "BeamDimension")



corner1(0) = pt(26) + b / 2 - Val(Len(Str(b))) * FontSz / 2
corner1(1) = pt(27) - 16 * cVrTemp
corner1(2) = 0
theight = 50  ''fix
text = Str(b)
Set acadObj = moSpace.AddText(text, corner1, theight)
  acadObj.layer = "BeamDimension"
  acadObj.Update
Call ArrowHorizontal(pt(26), pt(27) - 13 * cVrTemp, b, 30, 15, "BeamDimension")

Call ArrowVertical(pt(26), pt(27) - 12 * cVrTemp, -2 * cVrTemp, 0, 0, "BeamDimension")

Call ArrowVertical(pt(26) + b, pt(27) - 12 * cVrTemp, -2 * cVrTemp, 0, 0, "BeamDimension")
